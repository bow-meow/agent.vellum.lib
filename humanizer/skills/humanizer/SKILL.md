...
name: humanizer
description: >-
  Use when editing outbound prose so it reads human-written, not AI-generated — PR replies and
  descriptions, commit messages, Jira/Confluence comments, emails, docs. Triggers — "humanize
  this", "make it sound less AI", "strip the AI slop", "too formal/robotic", reviewing text before
  it's posted somewhere permanent. Based on Wikipedia's "Signs of AI writing" guide.
license: MIT
metadata:
  version: "2.13.0"
---
